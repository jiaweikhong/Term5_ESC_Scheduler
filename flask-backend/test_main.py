...
class TestMain(unittest.TestCase):
    def test_admin_login(self):
        self.assertEqual(main.check_admin_login("tom", "tommy"), 0) # correct username, wrong pw, should fail.
        self.assertEqual(main.check_admin_login("karen", "karen"), 0)   # instructor credentials should fail.
        self.assertEqual(main.check_admin_login("bob", "bob"), 0) # planner credentials should fail.
        self.assertEqual(main.check_admin_login("tom", "tom"), 1)   # correct username & pw, should pass.
    ...
    def test_instructor_login(self):
        ...
        self.assertEqual(main.check_instructor_login("karen", "karen"), 1)  # correct username & pw, should pass.
